...
<html lang="en">
	<head>
		...
		<!-- Google font -->
		<link href="{{ asset('electro-master') }}/https://fonts.googleapis.com/css?family=Montserrat:400,500,700" rel="stylesheet">
	...
	<body>
		...
		<script src="{{ asset('electro-master') }}/s/main.js"></script>
